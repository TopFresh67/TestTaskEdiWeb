...
# 5. Проверял, что это имя скачанного файла совпадает с именем файла-установщика, указанного на сайте
  ...
  Функция: UI
    ...
    Сценарий: Работа с web-страницей
      ...
      Тогда я должен увидеть текст на странице "Thousands of teams worldwide trust"

    Сценарий: Работа с web-страницей

      Когда захожу на страницу "https://www.ruby-lang.org/ru/"
      И захожу на страницу "https://www.ruby-lang.org/ru/downloads/"
      И кликаю по строке выдачи с адресом https://cache.ruby-lang.org/pub/ruby/3.1/ruby-3.1.2.tar.gz
      Тогда файл должен лежать в директории "/home/Загрузки"
      Тогда имя файла должно совпадать с именем на странице "ruby-3.1.2"